...
def test_symmetric() -> None:
    ...
    assert mul(-3.0, 12.0) == mul(12.0, -3.0)
...
def test_distribute() -> None:
    ...
    """
    assert mul(2.0, add(3.0, 4.0)) == add(mul(2.0, 3.0), mul(2.0, 4.0))
...
def test_other() -> None:
    ...
    """
    assert sigmoid(add(1.0, 2.0)) == sigmoid(1.0) + sigmoid(2.0)
    assert relu(add(1.0, 2.0)) == relu(1.0) + relu(2.0)
