    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _map(
        ...
        for ordinal in range(int(np.prod(out_shape))):
            ...
            outt = index_to_position(out_index, out_strides)
            inn = index_to_position(in_index, in_strides)

            out[outt] = fn(in_storage[inn])
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        for ordinal in range(int(np.prod(out_shape))):
            ...
            out[outt] = fn(a_storage[a], b_storage[b])
